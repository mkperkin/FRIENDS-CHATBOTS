...
# CHANG ME
# 0 is for spanish 1 is for english
mode = 0
  ...
  with tf.gfile.GFile(source_path, mode="r") as source_file:
    with tf.gfile.GFile(target_path, mode="r") as target_file:
      ...
      while source and target and (not max_size or counter < max_size):
        ...
        target_ids.append(prepare_helpers.EOS_ID)
...
def create_model(session, forward_only):
  ...
  ckpt = tf.train.get_checkpoint_state(gConfig['working_directory']+'/spanish/')
...
def train():
  ...
  enc_train = gConfig['working_directory'] + gConfig['train_enc']
  dec_train = gConfig['working_directory'] + gConfig['train_dec']
  enc_dev =  gConfig['working_directory'] + gConfig['test_enc']
  dec_dev =  gConfig['working_directory'] + gConfig['test_dec']
  ...
  with tf.Session() as sess:
    ...
    while True:
      ...
      if current_step % gConfig['steps_per_checkpoint'] == 0:
        ...
        checkpoint_path = os.path.join(gConfig['working_directory']+"/spanish/", "seq2seq.ckpt")
